...
@section('content')
<div class="container">
    <h1 class="mb-4">Edit Department #{{ $department->id }}</h1>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="department_code" class="form-control" id="department_code"
                           value="{{ old('department_code', $department->department_code) }}" placeholder="Enter department code (optional)">
                </div>
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" name="is_active" class="custom-control-input" id="is_active" value="1" {{ old('is_active', $department->is_active) ? 'checked' : '' }}>
