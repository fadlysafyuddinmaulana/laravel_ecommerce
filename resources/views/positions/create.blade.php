...
@section('content')
<div class="container">
    <h1 class="mb-4">Create Position</h1>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="position_name" class="form-control" id="position_name"
                                   value="{{ old('position_name') }}" placeholder="Enter position name" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="position_code" class="form-control" id="position_code"
                                   value="{{ old('position_code') }}" placeholder="Enter position code (optional)">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="level" id="level" class="form-control" required>
                                ...
                                <option value="1" {{ old('level') == 1 ? 'selected' : '' }}>1 - Director/Executive</option>
                                <option value="2" {{ old('level') == 2 ? 'selected' : '' }}>2 - Manager</option>
                                <option value="3" {{ old('level') == 3 ? 'selected' : '' }}>3 - Supervisor</option>
                                <option value="4" {{ old('level') == 4 ? 'selected' : '' }}>4 - Staff</option>
                                <option value="5" {{ old('level') == 5 ? 'selected' : '' }}>5 - Trainee/Intern</option>
                            </select>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" id="description" rows="4" 
                              placeholder="Enter position description, responsibilities, and requirements">{{ old('description') }}</textarea>
                </div>
