        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-8">
                <div class="w-full md:w-1/2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center text-center">
                            <img src="{{ asset('assets/furni-1.0.0/images/truck.svg') }}" alt="Fast & Free Shipping"
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center text-center">
                            <img src="{{ asset('assets/furni-1.0.0/images/bag.svg') }}" alt="Easy to Shop"
                                class="w-12 h-12 mb-2">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center text-center">
                            <img src="{{ asset('assets/furni-1.0.0/images/support.svg') }}" alt="24/7 Support"
                                class="w-12 h-12 mb-2">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 flex flex-col items-center text-center">
                            <img src="{{ asset('assets/furni-1.0.0/images/return.svg') }}" alt="Hassle Free Returns"
                                class="w-12 h-12 mb-2">
                ...
                <div class="w-full md:w-2/5 flex justify-center md:justify-end">
                    <img src="{{ asset('assets/furni-1.0.0/images/why-choose-us-img.jpg') }}" alt="Why Choose Us"
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                <div class="flex flex-col items-center bg-white rounded-lg shadow p-6">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_1.jpg') }}"
                ...
                <div class="flex flex-col items-center bg-white rounded-lg shadow p-6">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_2.jpg') }}"
                        class="w-24 h-24 rounded-full mb-4 object-cover">
                ...
                <div class="flex flex-col items-center bg-white rounded-lg shadow p-6">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_3.jpg') }}"
                        class="w-24 h-24 rounded-full mb-4 object-cover">
                ...
                <div class="flex flex-col items-center bg-white rounded-lg shadow p-6">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_4.jpg') }}"
                        class="w-24 h-24 rounded-full mb-4 object-cover">
            ...
            <div class="flex flex-col gap-8 items-center">
                <div class="w-full md:w-2/3 bg-gray-50 rounded-lg shadow p-6">
                    ...
                    <div class="flex flex-col items-center">
                        <img src="{{ asset('assets/furni-1.0.0/images/person-1.png') }}" alt="Maria Jones"
    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="row my-5">
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('assets/furni-1.0.0/images/truck.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('assets/furni-1.0.0/images/bag.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                                <h3>Easy to Shop</h3>
                                <p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('assets/furni-1.0.0/images/support.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                                <h3>24/7 Support</h3>
                                <p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.
                        ...
                        <div class="col-6 col-md-6">
                            <div class="feature">
                                <div class="icon">
                                    <img src="{{ asset('assets/furni-1.0.0/images/return.svg') }}" alt="Image"
                                        class="imf-fluid">
                                </div>
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="{{ asset('assets/furni-1.0.0/images/why-choose-us-img.jpg') }}" alt="Image"
                            class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_1.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 2 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_2.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 3 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_3.jpg') }}" class="img-fluid mb-5">
                ...
                <!-- Start Column 4 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('assets/furni-1.0.0/images/person_4.jpg') }}" class="img-fluid mb-5">
