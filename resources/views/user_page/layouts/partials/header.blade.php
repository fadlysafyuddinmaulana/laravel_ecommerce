...
<nav id="mainHeader" class="custom-navbar navbar navbar-expand-md navbar-dark bg-dark fixed-top transition-bg" arial-label="Furni navigation bar">
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarsFurni">
			<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
				   ...
				   <li class="nav-item">
					   <a class="nav-link {{ request()->routeIs('contact') ? 'active' : '' }}" href="#">Contact us</a>
				   </li>
			</ul>
