        ...
        <div class="row">
            <div class="col-12">
                <div class="row g-2 align-items-center justify-content-end mb-3">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('brands.create') }}" class="btn btn-filter-success">+ New Brand</a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="bulkDeleteForm" action="{{ route('brands.bulk-delete') }}" method="POST">
                            @csrf
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="d-flex justify-content-center align-items-center"
                                                    ...
                                                    <a href="{{ route('brands.edit', $brand) }}"
                                                        class="btn btn-figma-action" title="Edit Brand">
