...
class DemoDataSeeder extends Seeder
{
    public function run()
    {
        ...
        $employeeRows = [
            ['employee_code' => 'EMP001','first_name' => 'Budi','last_name' => 'Santoso','email' => 'budi.santoso@company.com','phone' => '081234567890','username' => 'budi.santoso','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'admin','position_code' => 'POS001','department_code' => 'POS001','hire_date' => '2023-01-15','status' => 'active'],
            ['employee_code' => 'EMP002','first_name' => 'Siti','last_name' => 'Nurhaliza','email' => 'siti.nurhaliza@company.com','phone' => '081234567891','username' => 'siti.nurhaliza','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS002','department_code' => 'POS002','hire_date' => '2023-02-20','status' => 'active'],
            ['employee_code' => 'EMP003','first_name' => 'Ahmad','last_name' => 'Wijaya','email' => 'ahmad.wijaya@company.com','phone' => '081234567892','username' => 'ahmad.wijaya','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'manager','position_code' => 'POS003','department_code' => 'POS003','hire_date' => '2023-01-10','status' => 'active'],
            ['employee_code' => 'EMP004','first_name' => 'Dewi','last_name' => 'Lestari','email' => 'dewi.lestari@company.com','phone' => '081234567893','username' => 'dewi.lestari','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS004','department_code' => 'POS004','hire_date' => '2023-03-15','status' => 'active'],
            ['employee_code' => 'EMP005','first_name' => 'Eko','last_name' => 'Prasetyo','email' => 'eko.prasetyo@company.com','phone' => '081234567894','username' => 'eko.prasetyo','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS005','department_code' => 'POS005','hire_date' => '2023-04-01','status' => 'active'],
            ['employee_code' => 'EMP006','first_name' => 'Rina','last_name' => 'Kusuma','email' => 'rina.kusuma@company.com','phone' => '081234567895','username' => 'rina.kusuma','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'manager','position_code' => 'POS006','department_code' => 'POS006','hire_date' => '2023-01-20','status' => 'active'],
            ['employee_code' => 'EMP007','first_name' => 'Andi','last_name' => 'Setiawan','email' => 'andi.setiawan@company.com','phone' => '081234567896','username' => 'andi.setiawan','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS007','department_code' => 'POS007','hire_date' => '2023-05-10','status' => 'active'],
            ['employee_code' => 'EMP008','first_name' => 'Maya','last_name' => 'Anggraini','email' => 'maya.anggraini@company.com','phone' => '081234567897','username' => 'maya.anggraini','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS008','department_code' => 'POS008','hire_date' => '2023-06-01','status' => 'active'],
            ['employee_code' => 'EMP009','first_name' => 'Rudi','last_name' => 'Hartono','email' => 'rudi.hartono@company.com','phone' => '081234567898','username' => 'rudi.hartono','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'manager','position_code' => 'POS009','department_code' => 'POS009','hire_date' => '2023-01-05','status' => 'active'],
            ['employee_code' => 'EMP010','first_name' => 'Linda','last_name' => 'Permata','email' => 'linda.permata@company.com','phone' => '081234567899','username' => 'linda.permata','password' => Hash::make('password'),'profile_image' => 'avatar.png','role' => 'staff','position_code' => 'POS010','department_code' => 'POS010','hire_date' => '2023-07-15','status' => 'active'],
        ];
