...
var FullCalendar = (function (e) {
  ...
  function yr(e, t) {
    ...
    return (
      r(i, ((n = e), (o = t.dateEnv), r(r({}, vr(n.range, o, n.allDay)), { allDay: n.allDay }))),
      i
    );
  }
  function Er(e, t, n) {
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ('title' === u)
              ((i = !1),
                r.push(_o('h2', { className: 'fc-toolbar-title', id: t.titleId }, t.title)));
            else {
      ...
      ((n.draggingSegEl = null),
        ...
        (n.handleHitUpdate = function (e, t, r) {
          ...
          (l &&
            ...
            c ? Ue() : We(),
            t ||
              (l && Us(a, e) && (l = null), (n.validMutation = l), (n.mutatedRelevantEvents = u)));
        }),
        (n.handleDragEnd = function (e) {
          var t = n.component.context,
            o = n.eventRange.def,
